...
(function(/*! Stitch !*/) {
  ...
  "library/dragdropFramework/dragdrop": function(exports, require, module) {(function($) {
    var defaultOptions = {
...
+function ($) { "use strict";
...
}, "components/mobileMenu/layout": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push('\n\n<div class="mobile-menu-icon" data-toggle="popover" data-animation="false" title="" data-html="true" data-placement="bottom">\n\n  ');
    
      __out.push(RSpine.icons.menu);
...
module.exports = content;}, "components/mobileMenu/liveApps": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
module.exports = content;}, "components/mobileMenu/mobileMenu": function(exports, require, module) {(function() {
  var MobileMenu, RSpine,
  ...
  MobileMenu = (function(_super) {
    __extends(MobileMenu, _super);

    MobileMenu.prototype.elements = {
      ".mobile-menu-icon": "mobileMenuIcon"
    };

    MobileMenu.prototype.events = {
      "click .live-app-icon": "onLiveAppIconClick"
    };

    function MobileMenu() {
      this.render = __bind(this.render, this);
      MobileMenu.__super__.constructor.apply(this, arguments);
      RSpine.bind("platform-app-launch-complete", this.render);
      RSpine.bind("platform:app-launch-complete", this.render);
      this.el.show();
      this.render();
    }
    ...
    MobileMenu.prototype.render = function() {
      var content;
      this.html(require("components/mobileMenu/layout")());
      content = require("components/mobileMenu/liveApps")({
        liveAppsByPath: RSpine.liveAppsByPath
      });
      return this.mobileMenuIcon.popover({
        content: content
      });
    };

    MobileMenu.prototype.onLiveAppIconClick = function(e) {
      var appPath, target;
      target = $(e.target);
...
module.exports = content;}, "library/modalFramework/test_spec": function(exports, require, module) {(function() {
  ...
  var moduleList = [
        ...
        {"namespace":"components","path":"components/mobileMenu/mobileMenu","iconColor": "","iconLabel": "","label": "","home": false},
    ...
    var css=".mobile-menu {  position: absolute;  top: 18px;  left: 22px;  width: 40px;  height: 40px;  border: 3px solid #fff;  padding: 4px;  z-index: 2000;  fill: #fff;}.mobile-menu .app-icon {  cursor: pointer;  width: 50px;  background-color: #f1f2f2;  height: 50px;  margin: 10px auto;  border: none;}.mobile-menu .app-icon.active {  border: 1px solid #8a8c8e;}.mobile-menu .app-icon .app-icon-header {  position: relative;  text-align: center;  border-bottom: none;  overflow: hidden;  padding: 0px 5px;  height: 13px;}.mobile-menu .app-icon .app-icon-header .triangle {  position: absolute;  left: 0px;  top: 0px;  width: 0px;  height: 0px;  border-style: solid;  border-width: 50px 48px 0 0;  border-color: rgba(255, 255, 255, 0.3) transparent transparent transparent;}.mobile-menu .app-icon .label {  line-height: 8px;  color: #fff;  font-size: 8px;  position: relative;  top: -3px;  text-transform: capitalize;  text-shadow: none;}.mobile-menu .app-icon .text {  margin: 0px auto;  color: #8a8c8e;  font-weight: 300;  font-size: 16px;  line-height: 25px;  text-align: center;  font-family: 'Roboto', sans-serif;  font-weight: 100;}.mobile-menu .side-icon {  border: none !important;  width: 34px !important;  margin: 5px auto;  position: relative;}.mobile-menu .side-icon.active .app-icon-header {  float: right;  position: relative;  left: 7px;}.mobile-menu .side-icon.active:hover .app-icon-header {  left: 7px;}.mobile-menu .side-icon .app-icon-header {  padding: 0px !important;  position: absolute;  left: -8px;  width: 8px !important;  height: 32px !important;  transition: all 0.2s ease-in-out;}.mobile-menu .side-icon:hover .app-icon-header {  left: 4px;}.mobile-menu .side-icon .text {  width: 26px;  font-size: 13px;  text-align: right;  float: left;}.mobile-menu .side-icon .text .text-header {  height: 10px;  overflow: hidden;  display: block;  font-size: 7px;  font-family: 'roboto';  text-align: right;  line-height: 10px;}";
