...
(function(/*! Stitch !*/) {
  ...
  "library/keyboardFramework/keyboardFramework": function(exports, require, module) {(function() {
  var KeyboardFramework, RSpine;

  RSpine = require("rspine");

  KeyboardFramework = (function() {
    function KeyboardFramework() {
...
}, "library/keyboardFramework/mousetrap": function(exports, require, module) {/*global define:false */
/**
...
}) (window, document);}, "library/dragdropFramework/dragdrop": function(exports, require, module) {(function($) {
    var defaultOptions = {
...
}, "library/dragdropFramework/dragdropFramework": function(exports, require, module) {(function() {
  var DragDropFramework, RSpine;

  RSpine = require("rspine");

  DragDropFramework = (function() {
    function DragDropFramework() {
...
}, "library/touchFramework/hammer": function(exports, require, module) {/*! Hammer.JS - v1.0.6dev - 2013-11-03
...
})(this);}, "library/touchFramework/jquery-hammer": function(exports, require, module) {/*! jQuery plugin for Hammer.JS - v1.0.0 - 2013-11-03
 * http://eightmedia.github.com/hammer.js
 *
 * Copyright (c) 2013 Jorik Tangelder <j.tangelder@gmail.com>;
 * Licensed under the MIT license */
...
})(this);}, "library/touchFramework/touchFramework": function(exports, require, module) {(function() {
  var RSpine, TouchFramework;

  RSpine = require("rspine");

  TouchFramework = (function() {
    function TouchFramework() {
...
}, "library/bootstrapFramework/bootstrapFramework": function(exports, require, module) {(function() {
  var BootstrapFramework, RSpine;

  RSpine = require("rspine");

  BootstrapFramework = (function() {
...
}, "library/bootstrapFramework/popover": function(exports, require, module) {/* ========================================================================
...
}, "library/bootstrapFramework/tooltip": function(exports, require, module) {/* ========================================================================
...
}, "library/modalFramework/layout": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
...
module.exports = content;}, "library/modalFramework/modalFramework": function(exports, require, module) {(function() {
  var ModalFramework, RSpine,
  ...
  ModalFramework = (function(_super) {
    __extends(ModalFramework, _super);

    ModalFramework.prototype.elements = {
      ".modal": "modal",
      ".modal-content": "modalContent"
    };

    function ModalFramework() {
      this.doHide = __bind(this.doHide, this);
      this.hide = __bind(this.hide, this);
      this.show = __bind(this.show, this);
      ModalFramework.__super__.constructor.apply(this, arguments);
      this.el = $("body");
      this.prepend(require("library/modalFramework/layout")());
      RSpine.bind("modal:show", this.show);
      RSpine.bind("modal:hide", this.hide);
      this.modal.hide();
      RSpine.trigger("platform:library-loaded-modal");
    }

    ModalFramework.prototype.show = function(Controller, options) {
      if (options == null) {
        options = {
          data: {}
        };
      ...
      $('button[data-dismiss="modal"]').on("click", this.hide);
      this.modal.show();
      return this.modal.addClass("in");
    };

    ModalFramework.prototype.hide = function(delay) {
      if (delay == null) {
        delay = false;
      }
      if (!this.controller) {
      ...
      $('button[data-dismiss="modal"]').off("click", this.hide);
      this.modalContent.empty();
      this.modal.removeClass("in");
      return this.modal.hide();
      if (delay) {
        return this.el.fadeOut(1800, this.doHide);
      } else {
        return this.doHide();
      }
    };

    ModalFramework.prototype.doHide = function() {
      var _ref;
...
}, "library/modalFramework/test_controller": function(exports, require, module) {(function() {
  var RSpine, TestController,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  TestController = (function(_super) {
    ...
    function TestController() {
      ...
      this.html(require("library/modalFramework/test_controller_layout")());
    }

    TestController.prototype.onClick = function() {
      return this.append('<div class="afterClick">This happend on click</div>');
    };
...
}, "library/modalFramework/test_controller_layout": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
module.exports = content;}, "library/modalFramework/test_spec": function(exports, require, module) {(function() {
  var exports, jQuery;
  ...
  describe('modalFramework', function() {
    before(function() {
      return this.modalFramework = require("library/modalFramework/modalFramework");
    });
    after(function() {});
    return describe("Constructor", function() {
      it("should show the layout", function() {
        $(".modal").should.not.equal(null);
        return $(".modal").css("display").should.equal("none");
      });
      it("should insert a controller", function() {
        var Controller;
        Controller = require("library/modalFramework/test_controller");
        RSpine.trigger("modal:show", Controller);
        return $(".modal").css("display").should.not.equal("none");
      });
      it("should bind controller events", function() {
        $(".modal-body").click();
        return $(".afterClick").should.not.equal(null);
      });
      ...
      return it("should close modal on click", function() {
        var Controller;
        Controller = require("library/modalFramework/test_controller");
        RSpine.trigger("modal:show", Controller);
        $('.close').click();
  ...
  var moduleList = [
        ...
        {"namespace":"library","path":"library/keyboardFramework/keyboardFramework","iconColor": "","iconLabel": "","label": "","home": false},
        ...
        {"namespace":"library","path":"library/dragdropFramework/dragdropFramework","iconColor": "","iconLabel": "","label": "","home": false},
        ...
        {"namespace":"library","path":"library/touchFramework/touchFramework","iconColor": "","iconLabel": "","label": "","home": false},
        
    
      
       
        {"namespace":"library","path":"library/bootstrapFramework/bootstrapFramework","iconColor": "","iconLabel": "","label": "","home": false},
        ...
        {"namespace":"library","path":"library/modalFramework/modalFramework","iconColor": "","iconLabel": "","label": "","home": false},
